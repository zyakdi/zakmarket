let JsonDB,Config;_04b‍.w("node-json-db",[["JsonDB",["JsonDB"],function(v){JsonDB=v}]]);_04b‍.w("node-json-db/dist/lib/JsonDBConfig",[["Config",["Config"],function(v){Config=v}]]);// Initialize the database with a few products.
